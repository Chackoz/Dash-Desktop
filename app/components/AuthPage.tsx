...
import { Loader, Terminal, Sun, Moon, ArrowRight, Mail, Lock, User } from 'lucide-react';
...
export const AuthPage = () => {
  ...
  return (
    <div className="min-h-screen w-screen flex flex-col items-center justify-center bg-background p-4 space-y-6">
